...
def gameLoop():
    ...
    while True:
        if (
                0 not in board and 1 not in board and 3 not in board and 4 not in board and 5 not in board 
                and 6 not in board and 7 not in board and 8 not in board):
            printw("You lose against the evil brain. The TicTacToe chamber explodes with you inside. You are dead...")
            adventure.gameOver()
        inp = input("Your turn: >")
        inp = int(inp)
        ...
        while True:
            if (
                    0 not in board and 1 not in board and 3 not in board and 4 not in board and 5 not in board 
                    and 6 not in board and 7 not in board and 8 not in board):
                printw("You lose against the evil brain. The TicTacToe chamber explodes with you inside. "
                       "You are dead...")
                adventure.gameOver()
            random.seed()
