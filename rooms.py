...
Each room in the dictionary ia a dictionary itself, containing the following:
    ...
    "info": a general description of the room. info is displayed at the beginning of each room and
        when the user types 'info','i'
...
rooms = {
    "your cell" : {
        ...
        "hint" : "Examine the corpse. It wears something you need in order to eliminate the guard. Take then "
                 "the guard's keys in order to open the door.",
    ...
    "the yard" : {
        ...
        "look" : "At the end of the yard, to the east, you find the Final Gate. It is the gate to "
                 "freedom. The gate has no keyhole,"
                 "but instead there is an opening mechanism at its center, with a headless dragon "
                 "drawn in it. It seems that the drawing must be completed with a dragon head"
                 " for the gate to open.",
        "exits" : ["east", "west"],
        "doorOpen" : {"west" : [True, "darkness"], "east" : [False, "TicTacToe"]},
        "items" : ["final gate"],
        "hint" : "Do you have anything in your inventory that has a dragon head drawn in it? Use it to open "
                 "the Final Gate.",
        "help" : "You can use these commands in this room: look / objects / take / , TODO"
    },
    "TicTacToe" : {
        "name" : "THE TICTACTOE CHAMBER",
        "info" : "You are one step away from freedom. Behind the final gate there is a chamber "
                 "with a big touch screen at its center. You have to play TicTacToe and win against an evil "
                 "electronic brain. This game is about life or death. Type 'play' to begin. "
                 "May God be with you now...",
        "look" : "You are one step away from freedom. Behind the final gate there is a chamber with a big "
                 "touch screen at its center."
                 " You have to play TicTacToe against an evil electronic brain. This match is about life or death. "
                 "Type 'play' to begin. May God be with you now...",
        "exits" : "",
        "doorOpen" : {},
