...
"keywords" : a list of recognized words for each item. These keywords
     are parsed in the function keywordSearch(), which returns the first value in "keywords", which also
     corresponds to the key in the item's dictionary (ex "corpse1" or "belt")
"hidden" : True means that the item is initially hidden and can't be listed by the command: objects
"takable1-3": A list consisting on a boolean value (True: the item can be taken) and the corresponding
    string that gets printed after it.
"movable1-3": A list consisting on a boolean value (True: the item can be moved) and the corresponding
    string that gets printed after it.
"kickable1-3": A list consisting on a boolean value (True: the item can be kicked) and the corresponding
    string that gets printed after it.
"""
items = {
    "corpse" : {
    ...
    "guard" : {
        ...
        "kickable1" : [False, "You call the guard. When he is near enough you kick him through the door "
                              "bars. The guard begins to scream. Two other guards come to help him. "
                              "They then kill you."],
